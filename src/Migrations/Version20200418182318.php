 ...
 */
final class Version20200418182318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, statu_id INTEGER NOT NULL, goal DOUBLE PRECISION NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, miniature VARCHAR(255) DEFAULT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2FB3D0EEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE55C16B5E FOREIGN KEY (statu_id) REFERENCES status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
