 ...
 */
final class Version20200325141607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, user_id, statu_id, limit_date, report, up, down, description, name, goal, miniature, title FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, statu_id INTEGER NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, goal DOUBLE PRECISION NOT NULL, miniature VARCHAR(255) DEFAULT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2FB3D0EEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE55C16B5E FOREIGN KEY (statu_id) REFERENCES status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, user_id, statu_id, limit_date, report, up, down, description, name, goal, miniature, title) SELECT id, user_id, statu_id, limit_date, report, up, down, description, name, goal, miniature, title FROM __temp__project');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, facebook_id INTEGER DEFAULT NULL, google_id INTEGER DEFAULT NULL, apple_id INTEGER DEFAULT NULL, instagram_id INTEGER DEFAULT NULL, linkedin_id INTEGER DEFAULT NULL, CONSTRAINT FK_8D93D6493D3D2749 FOREIGN KEY (children_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user (id, children_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id) SELECT id, child_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2FB3D0EEA76ED395');
        $this->addSql('DROP INDEX IDX_2FB3D0EE55C16B5E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, name, title FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, statu_id INTEGER NOT NULL, goal DOUBLE PRECISION NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, miniature VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO project (id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, name, title) SELECT id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, name, title FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEA76ED395 ON project (user_id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE55C16B5E ON project (statu_id)');
        $this->addSql('DROP INDEX IDX_A3C664D3A76ED395');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, children_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, facebook_id INTEGER DEFAULT NULL, google_id INTEGER DEFAULT NULL, apple_id INTEGER DEFAULT NULL, instagram_id INTEGER DEFAULT NULL, linkedin_id INTEGER DEFAULT NULL, child_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, child_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id) SELECT id, children_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649F85E0677 ON user (username)');
