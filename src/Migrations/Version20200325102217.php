 ...
 */
final class Version20200325102217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO project (id, user_id, statu_id, limit_date, report, up, down, description, name, goal, miniature, title) SELECT id, user_id, status_list_id, limit_date, report, up, down, description, name, goal, miniature, title FROM __temp__project');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, goal DOUBLE PRECISION NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, miniature VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, status_list_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO project (id, user_id, status_list_id, goal, limit_date, report, up, down, description, miniature, name, title) SELECT id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, name, title FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEA76ED395 ON project (user_id)');
