 ...
 */
final class Version20200326164557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, user_id, statu_id, limit_date, report, up, down, description, goal, miniature, title FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, statu_id INTEGER NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, goal DOUBLE PRECISION NOT NULL, miniature VARCHAR(255) DEFAULT NULL COLLATE BINARY, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2FB3D0EEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2FB3D0EE55C16B5E FOREIGN KEY (statu_id) REFERENCES status (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO project (id, user_id, statu_id, limit_date, report, up, down, description, goal, miniature, title) SELECT id, user_id, statu_id, limit_date, report, up, down, description, goal, miniature, title FROM __temp__project');
        ...
        $this->addSql('INSERT INTO user (id, children_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id) SELECT id, children_id, username, roles, password, email, facebook_id, google_id, apple_id, instagram_id, linkedin_id FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2FB3D0EEA76ED395');
        $this->addSql('DROP INDEX IDX_2FB3D0EE55C16B5E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__project AS SELECT id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, title FROM project');
        $this->addSql('DROP TABLE project');
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, statu_id INTEGER NOT NULL, goal DOUBLE PRECISION NOT NULL, limit_date DATE NOT NULL, report INTEGER NOT NULL, up INTEGER NOT NULL, down INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, miniature VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO project (id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, title) SELECT id, user_id, statu_id, goal, limit_date, report, up, down, description, miniature, title FROM __temp__project');
        $this->addSql('DROP TABLE __temp__project');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEA76ED395 ON project (user_id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EE55C16B5E ON project (statu_id)');
        $this->addSql('DROP INDEX IDX_A3C664D3A76ED395');
